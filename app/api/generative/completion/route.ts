...
async function implement_edits(user_inputs: string, file_name: string) {
  const response = await fetch(`http://localhost:3000/api/generative/implement_edits?user_inputs=${user_inputs}&file_name=${file_name}`, {
    method: "GET",
    headers: { "Content-Type": "application/json" },
  });
